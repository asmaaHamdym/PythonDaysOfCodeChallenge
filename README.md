...
| 30   | #Create a function that finds the second smallest element in a list.                                       | [code](https://github.com/asmaaHamdym/PythonDaysOfCodeChallenge/blob/main/30-secondSmallest.py)            |
