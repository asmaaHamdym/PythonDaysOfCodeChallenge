...
| 10   | #Write a program to remove duplicates from a list.                                                         | <a href="https://github.com/asmaaHamdym/PythonCodeOfCodeChallenge/blob/main/10-removeDuplictes.py">Code<a>           |
| 11   | #Write a program to print the multiplication table of a given number.                                      | <a href="https://github.com/asmaaHamdym/PythonCodeOfCodeChallenge/blob/main/11-numberMultiplicationTable.py">Code<a> |
...
| 15   | #Create a program that checks if a year is a leap year                                                     | <a href="https://github.com/asmaaHamdym/PythonCodeOfCodeChallenge/blob/main/15-leapYear.py">Code<a>                  |
